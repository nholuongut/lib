...
sub set_cassandra_port($){
    ...
    defined($DEFAULT_CASSANDRA_PORT{$type}) or code_error "'$type' cassandra port not defined in nholuongut::Cassandra::DEFAULT_CASSANDRA_PORT hash, passed in wrong type as arg?";
    %cassandra_options = (
        %cassandra_options,
