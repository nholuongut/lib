...
sub curl_mapr($$$;$){
    ...
    $json = isJson($content) or quit "CRITICAL", "invalid json returned by MapR Control System, perhaps you tried --no-ssl and SSL was used on that port? Try running with -vvv to debug and file as ticket if neccessary to https://github.com/nholuongut/Nagios-Plugins/issues";
    vlog3 Dumper($json);
    return $json;
}
