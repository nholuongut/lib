...
# Unit Tests for nholuongutUtils
...
BEGIN {
    ...
    use_ok('nholuongutUtils', qw/:DEFAULT :time/);
}
require_ok('nholuongutUtils');
...
use LWP::Simple '$ua';
ok(nholuongutUtils::defined_main_ua(), "defined_main_ua()");
...
# ============================================================================ #
ok(nholuongutUtils::isCode(sub{}), 'nholuongutUtils::isCode(sub{})');
ok(nholuongutUtils::isSub(sub{}), 'nholuongutUtils::isCode(sub{})');

ok(!nholuongutUtils::isCode(1), '!nholuongutUtils::isCode(1)');
ok(!nholuongutUtils::isSub(1), '!nholuongutUtils::isSub(1)');
...
is(isDomain("nholuongut.com"),  "nholuongut.com",   'isDomain("nholuongut.com") eq nholuongut.com');
is(isDomain("1nholuongut.com"), "1nholuongut.com",  'isDomain("1nholuongut.com") eq 1nholuongut.com');
...
is(isDomain("nholuongut"),      undef,              'isDomain("nholuongut") eq undef'); # not a valid TLD
...
is(validate_domain("nholuongut.com"),  "nholuongut.com",    'validate_domain("nholuongut.com") eq nholuongut.com');
...
is(isEmail("nholuongut"),               undef,                      '!isEmail("nholuongut") eq undef');

is(validate_email('nholuongut@domain.com'),      'nholuongut@domain.com',     'validate_email(\'nholuongut@domain.com\')');
...
# ============================================================================ #
is(validate_file("nholuongutUtils.pm"),        "nholuongutUtils.pm",  'validate_file("nholuongutUtils.pm")');
if(isLinuxOrMac()){
...
# ============================================================================ #
is(isFqdn("hari.sekhon.com"),   "hari.sekhon.com",  'isFqdn("hari.sekhon.com") eq nholuongut.com');
# denying this results in failing host.local as well
is(isFqdn("hari\@nholuongut.com"),    undef,        'isFqdn("hari\@nholuongut.com") eq undef');

is(validate_fqdn("www.nholuongut.com"),     "www.nholuongut.com",      'validate_fqdn("www.nholuongut.com")');
...
# ============================================================================ #
is(isHost("nholuongut.com"),    "nholuongut.com",   'isHost("nholuongut.com") eq nholuongut.com');
ok(isHost("nholuongut"),        'isHost("nholuongut")');
...
is(isAwsHostname("nholuongut"),        undef,              'isAwsHostname("nholuongut")');
...
# ============================================================================ #
is(isHostname("nholuongut.com"),  "nholuongut.com",   'isHostname("nholuongut.com") eq nholuongut.com');
is(isHostname("nholuongut"),      "nholuongut",       'isHostname("nholuongut")');
is(isHostname("a"),               "a", 'isHostname("a") eq a');
is(isHostname("1"),               "1", 'isHostname("1") eq 1');
is(isHostname("nholuongut1.com"), "nholuongut1.com", 'isHostname(nholuongut1.com) eq nholuongut1.com');
is(isHostname("1nholuongut.com"), "1nholuongut.com", 'isHostname(1nholuongut.com) eq 1nholuongut.com');
...
is(validate_hostname("nholuongut1.com"),     "nholuongut1.com",           'validate_hostname(nholuongut1.com) eq nholuongut1.com');
...
is(validate_krb5_realm("nholuongut.com"),  "nholuongut.com",    'validate_krb5_realm("nholuongut.com") eq nholuongut.com');
...
# ============================================================================ #
is(isNoSqlKey("nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc"), "nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc", 'isNoSqlKey() eq $key');
is(isNoSqlKey("nholuongut\@check_riak_write.pl"), undef, 'isNoSqlKey("...@...") eq undef');

# should error out with "node list empty"
is(validate_nosql_key("nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc"), "nholuongut:check_riak_write.pl:riak1:1385226607.02182:20abc", 'validate_nosql_key()');
...
# ============================================================================ #
#ok(nholuongutUtils::loginit(),   'nholuongutUtils::loginit()');
#ok(nholuongutUtils::loginit(),   'nholuongutUtils::loginit() again since it should be initialized by first one');
#ok(&nholuongutUtils::log("hari testing"), '&nholuongutUtils::log("hari testing")');
...
ok(!nholuongutUtils::validate_ssl_opts(), 'validate_ssl_opts()');

# This could do with a lot more unit testing
ok(nholuongutUtils::validate_threshold("warning", 75), 'validate_threshold("warning", 75)');
ok(nholuongutUtils::validate_threshold("critical", 90), 'validate_threshold("critical", 90)');
ok(validate_thresholds(), 'validate_thresholds()');
...
use nholuongutUtils ':log';
ok(loginit(), 'loginit()');

ok(nholuongutUtils::get_terminal_size(), 'get_terminal_size()');
ok(nholuongutUtils::check_terminal_size(), 'check_terminal_size()');
ok(nholuongutUtils::print_options(), 'print_options()');
...
ok(nholuongutUtils::version_string(), 'version_string()');
...
$verbose = 1;
ok(nholuongutUtils::vlog4("test1\ntest2"),   'vlog4("test1\ntest2")');
